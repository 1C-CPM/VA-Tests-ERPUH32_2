...
Сценарий: 04.01. ПЗ (План закупок)
	...
	* 	Добавляем в табличную часть Товар1
...
* 	Добавляем в табличную часть Товар5
		...
		Тогда открылось окно 'План закупок (создание) *'
		И я перехожу к следующему реквизиту
		И в таблице "ТоварыПоПериодам" в поле с именем 'ТоварыПоПериодамЦена' я ввожу текст '25 000,00'
		И я перехожу к следующему реквизиту
		
		И в таблице "ТоварыПоПериодам" я перехожу к следующей ячейке
		И в таблице "ТоварыПоПериодам" я перехожу к следующей ячейке
				
		И в таблице "ТоварыПоПериодам" в текущее поле я ввожу текст '1,000'
		И в таблице "ТоварыПоПериодам" я нажимаю на кнопку с именем 'СкопироватьПоСтроке'
		И в таблице "ТоварыПоПериодам" я завершаю редактирование строки
...
Сценарий: 04.20. [КП2: ПЗ -> Заказ] Заказ поставщику(ДД5)
	...
	* Убедимся, что сумма документа правильная (300 000,00)
		
		И в таблице 'Товары' я активизирую поле с именем 'ТоварыНоменклатура'
		Тогда элемент формы с именем 'СуммаВсегоСНДС' стал равен "300 000,00"
...
Сценарий: 04.22. [ЗП -> Протокол -> Договор] ЗП: переходная
	...
	* Вводим даты подготовки и официального размещения
		...
		И в поле с именем 'ДатаНачалаПодготовкиЗакупки' я ввожу текст "26.12.2025 10:00:00"
		И я перехожу к следующему реквизиту
		И в поле с именем 'ДатаОфициальногоОбъявленияЗакупки' я ввожу текст "05.01.2026 10:00:00"
		И я перехожу к следующему реквизиту
	...
	* Создаем лот
		...
		И в поле с именем 'ДатаИсполненияДоговора' я ввожу текст "31.12.2026 23:59:59"
		...
		И в таблице 'Номенклатура' в поле с именем 'НоменклатураДатаПоставки' я ввожу текст "05.01.2026"
		И я перехожу к следующему реквизиту
	...
	* Вводим договор
		...
		И я перехожу к следующему реквизиту
		И в поле с именем 'Дата' я ввожу текст "26.12.2025"
		И я перехожу к следующему реквизиту
		
		И в поле с именем 'НачалоДействия' я ввожу текст "26.12.2025"
		И я перехожу к следующему реквизиту
		И в поле с именем 'СрокДействия' я ввожу текст "31.01.2026"
		И я перехожу к следующему реквизиту
		И я перехожу к закладке с именем 'ГруппаГрафик'
		И в таблице 'ГрафикРасчетов' я нажимаю на кнопку с именем 'ГрафикРассчитатьПоГрафикуПоставок'
		И я нажимаю на кнопку с именем 'ФормаЗаписать'
